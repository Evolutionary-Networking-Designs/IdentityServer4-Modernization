...
namespace IdentityServer4.Hosting.LocalApiAuthentication
{
    ...
    public class LocalApiAuthenticationHandler : AuthenticationHandler<LocalApiAuthenticationOptions>
    {
        ...
        /// <inheritdoc />
        public LocalApiAuthenticationHandler(IOptionsMonitor<LocalApiAuthenticationOptions> options, ILoggerFactory logger, UrlEncoder encoder, TimeProvider clock, ITokenValidator tokenValidator)
